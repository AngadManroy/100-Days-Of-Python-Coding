# Simple Hill Climb with heureistic = +-1 to solve the block problem.
# Limitation: Heuristic function designed is not optimal and hence algorithm does not provide
# a good output.
import copy
