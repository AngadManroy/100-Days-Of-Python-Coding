# Solution to 8 puzzle problem using a heuristic function(Manhattan Distance)
# to convert Breadth first Search to Best first Search.
# Advantage: Reduces Time Complexity of our program
import numpy
import copy
import math
